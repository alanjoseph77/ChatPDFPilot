      ...
      <div className={cn(
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-foreground">ChatPDFPilot</h1>
            <Button
              variant="ghost"
              size="sm"
              className="md:hidden"
          ...
          <p className="text-sm text-muted-foreground mt-2">by Alan Joseph Monichan</p>
        </div>
              ...
              <div className="space-y-3">
                {documents.map((doc) => (
                  <Card
                    key={doc.id}
                    className={cn(
                      "p-4 cursor-pointer transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:border-blue-200 hover:scale-[1.02]",
                      selectedDocumentId === doc.id && "bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-300 shadow-lg"
                    )}
