...
import { summarizeDocument, generateSuggestedQuestions } from "./services/gemini.js";
import multer from "multer";
import { insertDocumentSchema, insertChatSessionSchema } from "../../../packages/shared/src/schema.js";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/documents/:id/questions", async (req, res) => {
    try {
      ...
      const questions = await generateSuggestedQuestions(document.content);
      res.json({ questions });
    } catch (error) {
